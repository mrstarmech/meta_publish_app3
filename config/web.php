    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'privacy' => 'site/index',
                '<controller:trap>/<action:\w+>' => '<controller>/<action>',
                '<controller:logc>/<action:\w+>/<id:\d+>' => '<controller>/<action>',
                '<controller:logc>/<action:\w+>' => '<controller>/<action>',
                '<controller:logc>' => 'logc/index',
