...
<body>
  ...
  <div class="main-content">
    <div class="container">
      <div class="row">
          ...
          <div class="left-content">
            <div class="post-one">
              ...
              <h2 class="font-poppins">
                Get results naturally,<br class="hidden-mb"> without looking like you ever got any work done
              </h2>
              <p class="font-weight-bold mt-2 mb-0 jen-heading">
                Jennifer Stallone Celebrates Over 25 Years of Changing Skincare
              </p>
              <div class="logo-box">
                <p class="text-uppercase mb-2">As Seen In</p>
                <div>
                  <img src="<?=$root_fld?>images/as-seen-img.png" class="img-fluid" alt="#">

                </div>
              </div>
              <img src="<?=$root_fld?>images/img-1-c.jpg" class="img-fluid w-100 mt-4 mb-3" alt="#">
              ...
              <p class="color-4">
                13.3 million people got cosmetic work done. The cosmetic industry brought in over 483 billion dollars in 2020. That’s a lot of people who take their appearance… seriously.
              </p>
              <p class="color-4">
                Speaking of serious…
              </p>
              <p class="color-4 mb-0">
                I recently had the chance to interview Jennifer Stallone - founder of Serious Skincare, mother of 3 daughters and wife to Sylvester Stallone.
              </p>
              ...
              <p class="color-4">
                Last year, Jennifer left the popular TV network to expand the reach of her <a href="<?= $offerLink ?>">Serious Skincare</a>. She talked about empathizing with how frustrating it is when you buy skincare products, expecting results, but only getting disappointment.
              </p>
              <p class="font-italic" style="font-weight: 500;">
                “When you want to see rapid results, and nothing REALLY works to reduce the appearance of Crow’s Feet and other expression wrinkles, it just sucks. So many cosmetic companies aren’t just selling hope, they’re stealing it. That’s why we developed Insta-Tox. You can instantly plump, tighten and smooth out your wrinkles, minus that ‘just got work done’ appearance.”
              </p>
              <p class="color-4">
                Jennifer <a href="<?= $offerLink ?>">spills the tea</a> on how it’s possible to get ageless-looking results, while stimulating the Fibroblasts and boosting your natural Collagen production.
              </p>
            </div>
              ...
              <div class="pro-inner-box">
                <div class="pro-inner-box-left">
                  <label class="check-container"><span>Step 1:</span>
                    Get Up To 40% Off of INSTA-TOX™ Instant Wrinkle-Smoothing Serum
        ...
        <div class="col-md-4">
          <div class="right-content">
            <div class="reader-result ">
              ...
              <img src="<?=$root_fld?>images/side-img3.png" class="img-fluid like-icon mt-4" alt="#">
              <p class="pt-4">
                "I love the <span class="font-weight-bold">Insta-Tox Wrinkle
                  Smoothing Serum </span>and Serious Skincare. I've been
                using the product for years and I'm a believer.
                The results speak for themselves and I'm happy in my own skin."
              </p>
              <p class="mb-0"><span class="font-weight-bold">— Cherry B.,</span> Texas</p>
            </div>
            <div class="pro-box2 d-none d-md-block">
              <div class="pro-box2-hd">
                <h4>Special Offer</h4>
              </div>
              <div class="pro-box2-inr mt-4">
                <label class="check-container"><span>Step 1:</span>
                  <br>Get Up To 40% Off of INSTA-TOX™ Instant Wrinkle-Smoothing Serum
                  <input type="checkbox" checked="checked">
                  <span class="checkmark"></span>
                </label>
                ...
                <p class="text-center" style="font-size: 15px;">
                  Take advantage of our exclusive link and get up to <strong>40% OFF + FREE SHIPPING!</strong></p>
              </div>
            </div>
            <div class="review-right ">
              <div class="review-right1">
                <img src="<?=$root_fld?>images/side-img2.png" class="img-fluid mb-3" alt="#">
                <p>”<span class="f-500">Insta-Tox Wrinkle Smoothing Serum</span>
                  is my absolute favorite and my go-to gift for all of my girlfriends. I wish I knew about this product before I had injections! I would have saved a heck of a lot of money!"
                </p>
                <p class="mb-0"><span class="f-500">— Karry S.,</span> Georgia</p>
              </div>
              <div class="review-right2">
                <img src="<?=$root_fld?>images/side-img1.png" class="img-fluid mb-3" alt="#">
                <p>”<span class="f-500">Insta-Tox Wrinkle Smoothing Serum</span>
                  is the best product and my favorite in the Serious Skincare line. I was skeptical at first, but within a few weeks of using the set I already see results. Can't wait to see how I look in the future."
                </p>
        ...
        <div class="review-container col-md-8 pad-right">
          <div class="review-hd">
            <h4>10 Comments</h4>
          </div>
          <div class="review-box d-flex">
            ...
            <div class="review-txt">
              ...
              <p class="u-cmnt mb-0">This product will not only extend your makeup to long wear, but also gives a flawless finish while tightening, I've used this product for several years &amp; keep a back on hand as I don't ever want to run out. The four tube set is a best buy. Only use a small amount for best results.
              </p>
          ...
          <div class="review-box d-flex num-2">
            ...
            <div class="review-txt">
              ...
              <p class="u-cmnt mb-0">
                I have used Insta-Tox for 4 years and it absolutely works. I am 62 and when applied, my face (crowsfeet &amp; around mouth) look so smooth. Just use a little and rub it upward in tiny strokes while it dries. It stays on till you wash it off. Used to buy from HSN, but since they stopped selling there I buy here now. Amazing.
              </p>
              <div class="review-text-cmnt">
              </div>
            </div>
          ...
          <div class="review-box d-flex num-2">
            ...
            <div class="review-txt">
              ...
              <p class="u-cmnt mb-0">
                Amazed by the results! Thank you SSC for outstanding products.
              </p>
              <div class="review-text-cmnt">
              </div>
            </div>
          ...
          <div class="review-box d-flex num-2">
            ...
            <div class="review-txt">
              <p class="u-name">
                Theresa Penka Williams
              </p>
              <p class="u-cmnt mb-0">
                Been using this product for 20+ years and I love her to death, nothing else works better nothing else works better for the money.
              </p>
              <div class="review-text-cmnt">
              </div>
            </div>
          ...
          <div class="review-box d-flex num-2">
            ...
            <div class="review-txt">
              ...
              <p class="u-cmnt mb-0">
                I just bought the Insta-Tox for my mother since she just turned 40 and is showing some eye wrinkgles. I told her this product will help and she is loving it.
              </p>
              <div class="review-text-cmnt">
              </div>
            </div>
          ...
          <div class="review-box d-flex num-2">
            ...
            <div class="review-txt">
              ...
              <p class="u-cmnt mb-0">
                I love the products. They do everything they say. I have used them for about 15 years and have no complaints.
              </p>
              <div class="review-text-cmnt">
              </div>
            </div>
          ...
          <div class="review-box d-flex num-2">
            ...
            <div class="review-txt">
              ...
              <p class="u-cmnt mb-0">
                My skin looks so much better. It's smooth and I honestly look 10 years younger. I love all of the the products. I have been using them for 3 years. My skin just keeps looking better.
              </p>
              <div class="review-text-cmnt">
              </div>
            </div>
  ...
  <footer>
    <div class="container">
      <p class="ftr-txt">
        <a style="cursor:pointer" class="fancybox fancybox.iframe">Terms &amp; Conditions</a> &nbsp;|&nbsp;
        <a style="cursor:pointer" class="fancybox fancybox.iframe">Privacy Policy</a> &nbsp;|&nbsp;
        <a style="cursor:pointer" class="fancybox fancybox.iframe">Shipping &amp; Returns</a> &nbsp;|&nbsp;
        <a style="cursor:pointer" class="fancybox fancybox.iframe">Contact Us</a> &nbsp;
      </p>
      <p>Disclaimer: These products are not intended to diagnose, prevent, treat, or cure any disease. The stories depicted on this site and the person(s) depicted in the story are not real unless stated otherwise. Rather, the story is based on the results that some people who have used these products have achieved. The results portrayed in the story and in the comments are illustrative, and may not be the results that you achieve with these products.<br><br>
        <a href="<?=$offerLink?>" title="DMCA.com Protection Status" class="dmca-badge"> <img src="<?=$root_fld?>images/dmca_protected_sml_120l.png" alt="DMCA.com Protection Status"></a>
      </p>
    </div>
    <div class="copy-txt">
      <div class="container">
